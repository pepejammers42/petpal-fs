        ...
        <div className={`${flexBetween} mx-auto w-[1194px]`}>
          <div className={`${flexBetween} w-full md:gap-16`}>
            <div className={`${flexBetween} gap-2 md:gap-6`}>
              ...
              {isAboveMedium ? (
                ...
                >
                  ...
                  {/*   Home */}
                  {/* </p> */}
                  <p className="text-bg-accent px-6 py-4 hover:py-5 hover:text-fg-alt-3 hover:bg-primary-100">
                    Home
                  </p>
            ...
            <div className={`${flexBetween} gap-6 font-cinzel`}>
              <p className="text-fg-alt-3 text-xs md:text-base">Log in</p>
              <p className="bg-fg-accent px-3 py-1.5 rounded-md text-xs md:text-base text-bg-alt-3">
                Sign up
              </p>
            </div>
          </div>
